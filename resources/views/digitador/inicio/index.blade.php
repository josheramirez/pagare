                    ...
                    <div class="card-body">
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                <h4 class="text-secondary">Mis pagare relizados: <a href="{{ route('digitador.buscar.mispagare') }}" class="badge badge-pill badge-primary">{{ $num_pagare }}</a> |</h4>
                            </li>
                            <li class="list-inline-item">
                                <h4 class="text-secondary">Pagare sin validar: <a href="{{ route('digitador.buscar.sinValidar') }}" class="badge badge-pill badge-warning">{{ $num_pagare_abierto }}</a></h4>
                            </li>
                        </ul>
                        <hr>
...
<!-- SECCION BUSCADOR POR N° DE PAGARE -->
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        {!! Form::open(['route'=> 'digitador.buscar.numero', 'method' => 'POST', 'id' => 'formNumero']) !!}
                                        <div class="form-group">
...
<!-- SECCION BUSCADOR POR RUT -->                            
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">RUT Deudor</h5>
                                        <p class="card-text">Para buscar el Pagare debe ngresar el RUT del deudor</p>
                                        {!! Form::open(['route'=> 'digitador.buscar.rut', 'method' => 'POST', 'id' => 'formRut']) !!}
                                        <div class="form-group">
                                            {!! Form::label('rut', 'RUT') !!}
                            ...
                            <div class="col-md-4" style="padding-top: 30px">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        {!! Form::open(['route'=> 'digitador.buscar.paciente', 'method' => 'POST', 'id' => 'formPaciente']) !!}
