...
<div class="container">
    ...
    {!! Form::open(['route'=> 'pagare.deudor-deuda.store', 'method' => 'POST']) !!}
    ...
    <div class="row text-right">
        <div class="col-md-12">
            {!! link_to(route('digitador.index'),'Volver', ['class' => 'btn btn-outline-secondary']) !!}
...
@section('scripts')
  ...
  <script>
        ...
        function funcion_ajax() {
            ...
            var route='{{route('digitador.buscar.peticion')}}';
